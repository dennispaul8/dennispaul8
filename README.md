...
- **Sui Faucet dApp** – A user-friendly interface to request test tokens on the Sui network for development and testing purposes. https://suicet.vercel.app/
- **On-chain Voting dApp** – A frontend platform that lets users view proposals and cast votes directly on-chain. https://movevote.vercel.app/
